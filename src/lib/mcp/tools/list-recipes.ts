...
export default defineTool({
  ...
  description:
    "List Baristo recipes with optional filters by roast (Medium, Medium-Dark, Truly Dark) and brew method (Moka Pot, French Press, Pour-Over, Espresso). Returns a summary; use get_recipe for full brewing steps.",
  inputSchema: {
    roast: z.enum(["Medium", "Medium-Dark", "Truly Dark"]).optional(),
