...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Baristo.Online — For Expresso Noble Minds" },
      {
        name: "description",
        content: brandSubtitle,
      },
      { name: "author", content: "Baristo.Online" },
      { property: "og:title", content: "Baristo.Online — For Expresso Noble Minds" },
      {
      ...
      { name: "twitter:title", content: "Baristo.Online — For Expresso Noble Minds" },
